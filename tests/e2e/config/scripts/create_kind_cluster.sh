...
create_kind_cluster() {
  if [ ${K8S_VERSION} == 1.21 ]; then
    KIND_IMAGE="kindest/node:v1.21.12@sha256:f316b33dd88f8196379f38feb80545ef3ed44d9197dca1bfd48bcb1583210207"
  elif [ ${K8S_VERSION} == 1.22 ]; then
    KIND_IMAGE="kindest/node:v1.22.9@sha256:8135260b959dfe320206eb36b3aeda9cffcb262f4b44cda6b33f7bb73f453105"
    ...
    KIND_IMAGE="ghcr.io/verrazzano/kind-jenkins:v1.25.8-20230510051659-10f25717"
